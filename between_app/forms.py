...
from .models import BigTraditions, Components, EmailSent, PersonalStyle
...
class StyleForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            "follower_1": "Follower: I prefer to keep a following position, by allowing the client to guide as I actively listen.",
            "propositive_1": "Propositive: I prefer to propose things in the session, offering activities or exercises.",
            "challenger_1": "Challenger: I prefer to point to things that may be hidden or conflictive on what I see in the session.",
...
class StyleFormClient(forms.ModelForm):
    class Meta:
        ...
        labels = {
            "follower_1": "Follower: I prefer someone who follows me, by listening actively and giving me space to express myself.",
...
class BigTradForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            "hemeneutic": "Hermeneutic: I believe we can understand symbols and hidden patterns of people, texts, and the world by interpreting them, going deeper and deeper in the truth behind the signs and symbols.",
...
class SendEmailForm(forms.ModelForm):
    class Meta:
        ...
        fields = ("email",)
        labels = {
            "email": "Please press send if you are singed up or write an email if not",
        }
