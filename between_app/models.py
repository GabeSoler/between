...
class PersonalStyle(models.Model):
    ...
    acceptant_1 = models.IntegerField(default=50)
    intensive_1 = models.IntegerField(default=50)
    extensive_1 = models.IntegerField(default=50)
    divider_1 = models.IntegerField(default=50)
    containment_1 = models.IntegerField(default=50)
    becoming_1 = models.IntegerField(default=50)
    development_1 = models.IntegerField(default=50)
