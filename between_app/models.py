...
class PersonalStyle(models.Model):
    ...
    follower_1 = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    propositive_1 = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    challenger_1 = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    acceptant_1 = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    intensive_1 = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    extensive_1 = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    divider_1 = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    containment_1 = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    becoming_1 = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    development_1 = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    individuation_1 = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    belonging_1 = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
...
class BigTraditions(models.Model):
    ...
    # Big five traditions
    hemeneutic = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    phenomenological = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    cybernetic = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    spiritual = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    scientific = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    constructive = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
    participatory = models.IntegerField(
        default=50, help_text="Move right for support of the statement, and left for disagreement"
    )
...
class PersonalStyleGroup(models.Model):
    ...
    section = models.ForeignKey(
        PersonalStyleSection, default=None, on_delete=models.CASCADE
    )  # profile, path, tradition
    ...
    is_for_therapist = models.BooleanField(default=True)
